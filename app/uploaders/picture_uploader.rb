...
class PictureUploader < CarrierWave::Uploader::Base
  ...
  # Process uploaded file to ensure file is not too large
  process :resize_to_fit => [1000,1000]

  # Create different versions of your uploaded files:
  # create a thumb nail version of images
  version :thumb do
  ...
  @@filters = %w(toaster lomo kelvin colortone gotham)
  def filters
    @@filters
  end
  
  # For each available filter, generate a preview version
  @@filters.each do |ver|
    version ver, :from_version => :thumb_large do
      process "#{ver.to_s}_filter".to_sym
    end
  end
  ...
  # ------ Filter Functions Appear Below This Line ------
  # Important note: these pretty filters are from:
  # https://gist.github.com/tonycoco/2910540
  # Original author: Tony Coco
